...
class WakewordService {
  ...
  async start() {
    ...
    const pythonPath = Store.get('wakeword_python_path',
      Store.get('asr_python_path', DEFAULT_PYTHON_PATH));
    const port = Store.get('wakeword_port', DEFAULT_PORT);
    const asrPort = Store.get('asr_port', 18920);
